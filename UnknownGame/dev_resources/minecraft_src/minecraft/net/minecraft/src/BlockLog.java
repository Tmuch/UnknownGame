...
public class BlockLog extends BlockRotatedPillar
{
    ...
    public void registerIcons(IconRegister par1IconRegister)
    {
        ...
        {
            this.field_111052_c[var2] = par1IconRegister.registerIcon(this.func_111023_E() + "_" + woodType[var2]);
            this.tree_top[var2] = par1IconRegister.registerIcon(this.func_111023_E() + "_" + woodType[var2] + "_top");
        }
    }
}
