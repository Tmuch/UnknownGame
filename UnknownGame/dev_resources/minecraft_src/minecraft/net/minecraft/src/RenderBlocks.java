    ...
    public boolean renderBlockFluids(Block par1Block, int par2, int par3, int par4)
    {
        ...
        else
        {
            ...
            if (this.renderAllFaces || var10)
            {
                ...
                var5.addVertexWithUV((double)(par2 + 0), (double)par3 + var24, (double)(par4 + 0), var41, var49);
                var5.addVertexWithUV((double)(par2 + 0), (double)par3 + var26, (double)(par4 + 1), var39, var47);
                var5.addVertexWithUV((double)(par2 + 1), (double)par3 + var28, (double)(par4 + 1), var45, var53);
                var5.addVertexWithUV((double)(par2 + 1), (double)par3 + var30, (double)(par4 + 0), var43, var51);
            }
            ...
            for (int var56 = 0; var56 < 4; ++var56)
            {
                ...
                Icon var40 = this.getBlockIconFromSideAndMetadata(par1Block, var56 + 2, var23);

                if (this.renderAllFaces || var12[var56])
                {
                    if (var56 == 0)
                    {
                        var41 = var24;
                    ...
                    var13 = true;
                    float var60 = var40.getInterpolatedU(0.0D);
                    ...
                    var5.setBrightness(par1Block.getMixedBrightnessForBlock(this.blockAccess, var58, par3, var59));
                    float var55 = 1.0F;
                    ...
                    var5.addVertexWithUV(var43, (double)par3 + var41, var49, (double)var60, (double)var35);
                    ...
                    var5.addVertexWithUV(var43, (double)(par3 + 0), var49, (double)var60, (double)var54);
                }
            }
