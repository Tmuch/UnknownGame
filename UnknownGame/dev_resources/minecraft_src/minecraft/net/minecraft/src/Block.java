...
public class Block
{
    ...
    {
    	ItemStack[] is = par5EntityPlayer.inventory.mainInventory;
    	int index = -1;
    	for(int i = 0; i < is.length; i++)
    	{
    		if(is[i] != null
    				&& (is[i].getItem() instanceof ItemTool)
    				&& ((ItemTool)is[i].getItem()).isEffective(this))
    		{
    			index = i;
    			break;
    		}
    	...
    	par5EntityPlayer.inventory.setCurrentItem(is[index].itemID, 0, false, false);
    }
