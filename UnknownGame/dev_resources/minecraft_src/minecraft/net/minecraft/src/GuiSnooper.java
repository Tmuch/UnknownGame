...
public class GuiSnooper extends GuiScreen
{
    ...
    public void initGui()
    {
        this.snooperTitle = I18n.func_135053_a("options.snooper.title");
        ...
        this.buttonList.add(new GuiButton(2, this.width / 2 + 2, this.height - 30, 150, 20, I18n.func_135053_a("gui.done")));
